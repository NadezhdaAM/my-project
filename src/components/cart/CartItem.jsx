...
const CardItem = (props) => {
  ...
  const onAddOverlay = async (obj)=>{
    try{
      ...
      if(findOverlay){
        axios.delete(`https://6444d55bb80f57f581abdf13.mockapi.io/cart/${findOverlay.id}`)
        props.setOverlayItems((over) => over.filter(o=>o.myId !== obj.myId))
      }
      else{
        const {data} = await axios.post('https://6444d55bb80f57f581abdf13.mockapi.io/cart', obj)
